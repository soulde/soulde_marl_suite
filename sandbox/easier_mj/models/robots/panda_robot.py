...
class Panda(Robot):
    ...
    def set_base_xpos(self, pos):
        ...
        node = self.worldbody.find("./body[@name='{}link0']".format(self.prefix))
    ...
    def _link_body(self):
        ...
        return [self.prefix + i for i in ["link1", "link2", "link3", "link4", "link5", "link6", "link7"]]

    @property
    def _joints(self):
        return [self.prefix + i for i in ["joint1", "joint2", "joint3", "joint4", "joint5", "joint6", "joint7"]]
